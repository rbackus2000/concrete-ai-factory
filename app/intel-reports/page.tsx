...
import { GenerateReportButton } from "@/components/intel-reports/generate-report-button";
  ...
  return (
    <div className="space-y-6">
      <header className="flex flex-wrap items-start justify-between gap-4">
        ...
        {/* Each run bills real tokens and web searches, so the manual trigger is
            admin-only. generateIntelReportAction enforces this server-side too. */}
