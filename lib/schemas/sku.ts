...
export const skuSchema = z.object({
  ...
  drainType: z.string().default(""),
  basinSlopeDeg: z.number().default(0),
  slopeDirection: z.string().default(""),
  mountType: z.string().default(""),
  hasOverflow: z.boolean().default(false),
  overflowHoleDiameter: z.number().default(0),
  overflowPosition: z.string().default(""),
  bracketSpec: z.object({
    bracketModel: z.string(),
    bracketCount: z.number().int(),
    bracketToCenter: z.string(),
    wallType: z.string(),
    channelWidthIn: z.number(),
    channelDepthIn: z.number(),
    channelLengthIn: z.number(),
    channelSpacingFromCenter: z.string(),
    hardwareBom: z.array(z.object({
      item: z.string(),
      qty: z.string(),
...
export const skuEditorSchema = z.object({
  ...
  basinSlopeDeg: z.coerce.number().nonnegative().optional().default(0),
  slopeDirection: z.string().optional().default(""),
  mountType: z.string().optional().default(""),
  hasOverflow: z.boolean().optional().default(false),
  overflowHoleDiameter: z.coerce.number().nonnegative().optional().default(0),
  overflowPosition: z.string().optional().default(""),
